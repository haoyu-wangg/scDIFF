...
def get_args():
    ...
    p.add_argument('-i', "--data", type=str, default="../../data/BoneMarrowB_BoneMarrowA.h5ad", help="path to the input h5ad file")
    ...
    p.add_argument("--root_path", default="../../data/", help="epidata root path")
